...
def insert():
    ...
    qnr = Questionnaire(
        ...
        risk_rules={
            "basis": "total_score",
            "total_score_ranges": [
                {"min": 100, "max": 155, "level": "low"},
                {"min": 156, "max": 210, "level": "medium"},
                {"min": 211, "max": 290, "level": "high"},
                {"min": 291, "max": 400, "level": "urgent"},
            ],
            "dimension_pct_rules": [
                {"dimension": "self_trait", "min_pct": 70, "level": "high"},
                {"dimension": "social_rule", "min_pct": 70, "level": "high"},
                {"dimension": "family", "min_pct": 65, "level": "medium"},
                {"dimension": "digital", "min_pct": 65, "level": "medium"},
            ],
            "risk_tag_rules": {
                "self_safety": {"level": "high", "type_label": "自我安全关注信号"},
                "antisocial": {"level": "high", "type_label": "反社会倾向信号"},
