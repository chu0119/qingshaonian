...
import { RISK_LABELS, RISK_COLORS, INTERVENTION_STATUS_LABELS, QUALITY_LABELS } from '../../utils/constants';
    ...
    { title: '时间', dataIndex: 'created_at', key: 'created_at', render: (v: string) => v ? new Date(v).toLocaleString('zh-CN') : '-' },
    {
      ...
      render: (_: any, r: any) => (
        <Space>
          ...
          <Button size="small" type="link" onClick={() => { setAnswerAlertId(r.id); setAnswerOpen(true); }}>答题详情</Button>
        </Space>
      ),
    },
  ];
